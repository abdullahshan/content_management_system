                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h4 style="font-size:20px; display:inline-block;">
                            ...
                            <a class="btn btn-primary" href="{{ route('contact.share', $id) }}">Add Shair</a>
                        </h4>

                        <a class="btn btn-primary" href="{{ route('contact.nominee_form', $id) }}">Customer Nominee</a>
                        <a class="btn btn-primary"
                            href="{{ route('contact.nomineetoshare_form', $id) }}">Share Nominee</a>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-responsive">
                            ...
                            @forelse ($nomeni as $s_share)
                                ...
                                <table class="table table-responsive">
                                    <tr>
                                        <td> <span style="font-size:20px;color:black">Customer Name : {{ $s_share->customer->name }}</span></td>
                                    </tr>
                                </table>
                                <table class="table table-responsive">
                                        ...
                                        <tr>
                                            <td> <img src="{{ asset('storage/' . $s_share->image) }}" alt="Girl in a jacket"
                                                ...
                                                <td>{{ $s_share->name }}</td>
                                                <td>{{ $s_share->relation }}</td>
                                                <td>0{{ $s_share->phone }}</td>
                                                <td>0{{ $s_share->mobile }}</td>
...
<div class="d-flex justify-content-center">
    <span style="font-size:20px;color:black;margin-bottom:17px;">Add Nominee for Customer</span>
   </div>
<hr>


                        <form class="mb-5" action="{{ route('contact.nominee_store', $id) }}" method="POST"
