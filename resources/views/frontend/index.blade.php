            ...
            <form action="{{ route('book') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <br>
                        <select for="block" id="block" name="block" style="width: 100%; padding:1%">
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="road" id="road" style="width: 100%; padding:1%">
                    ...
                    <div class="col-lg-6 mt-2">
                        ...
                        <select name="plot" id="plot" style="width: 100%; padding:1%">
                    ...
                    $('#block').change(function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                <img style="display: block;margin-left: auto;margin-right: auto;width: 50%;" src="{{ asset('storage/') }}/${result.block_info.image}" alt="">
